...
export const MAN_PAGES: Record<string, ManPage> = {
  ...
  top: {
    ...
    examples: ["$ top"],
    seeAlso: ["knowledge(1)", "top(1)"],
  },
  knowledge: {
    name: "knowledge",
    synopsis: "knowledge",
    description: "Navigate to knowledge graph and display index statistics.",
    examples: ["$ knowledge", "$ graph"],
    seeAlso: ["index(1)", "goto(1)"],
  },
  graph: {
    name: "graph",
    synopsis: "graph",
    description: "Alias for knowledge — opens the interactive knowledge map.",
    examples: ["$ graph"],
    seeAlso: ["knowledge(1)"],
  },
  index: {
    name: "index",
    synopsis: "index --knowledge",
    description: "Build and render the portfolio knowledge graph index.",
    examples: ["$ index --knowledge"],
    seeAlso: ["knowledge(1)", "goto(1)"],
  },
  skills: {
    name: "skills",
    synopsis: "skills",
    description: "Deprecated alias for knowledge — navigates to knowledge graph.",
    examples: ["$ skills"],
    seeAlso: ["knowledge(1)", "index(1)"],
  },
  shutdown: {
    name: "shutdown",
